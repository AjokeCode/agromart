  ...
  return (
    <div className="git" data-aos="zoom-in-up" data-aos-duration="1500">
      ...
      <div className="git-grid">
        ...
        >
          <img src={img} alt="img" className="git-grid-1-img" />
          <h1 className="git-grid-1-header">Phone</h1>
          <h1 className="git-grid-1-header-2">
            Give us a call during office hour
          </h1>
        ...
        >
          <img src={img} alt="img" className="git-grid-1-img" />
          <h1 className="git-grid-1-header">Locations</h1>
          <h1 className="git-grid-1-header-2">
            Come and see us Mon-Fri 9am-5pm
          </h1>
