...
const ProductFilter = ()=>{
    return(
        <div>
            <Header/>
            <section className='about-header-2'>
            ...
            <div className='about-header-heads'>
                ...
                <p className='about-header-title'>
                    Discover all categories of our farm-to-table pricing and order fresh products deliver 
                    straight to your doorstep, or visit us at the farm for a closer look to our sustainable farming 
                    practices.
                </p>
                <p className='pf-text'>Unable to find what you are looking for here? Order manually</p>
                <div className='hero-btns'>
                <button className='hero-btn hero-btn-1'>
                <Link to={'/'} className='hero-link'>Order Manually</Link>
                </button>
                <button className='hero-btn hero-btn-2'>
                <Link to={'/'} className='hero-link'>Track Order</Link> 
                </button>
                </div>
        ...
        <div className='explore-flex'>
            ...
            <input placeholder='Search any products here' type='text' className='explore-input1'/>
