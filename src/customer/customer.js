      ...
      <div className="customer-review">
        ...
        >
          ...
          <div className="customer-review-1-right">
            ...
            <p className="customer-review-1-text">
              "The quality of the products is outstanding, everything arrives in
              fresh and in great condition. I love that i can support local
              farmers while enjoying high quality products at reasonable prices"
            </p>
        ...
        >
          ...
          <div className="customer-review-1-right">
            <img src={img4} alt="img" className="customer-review-rate" />
            <p className="customer-review-1-text">
              "I recently tried out this website for the first time and i was
              blown away by the varieties of products available. I was able to
              find all of my favorite fruts and vegetables as well as some
              unique and hard to find item"
            </p>
